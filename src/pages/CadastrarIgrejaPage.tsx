    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Preencha o formulário abaixo para começar a usar o Connect Vida.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="cnpj" type="text" placeholder="Apenas números" value={cnpj} onChange={(e) => setCnpj(e.target.value)} className="pl-10 h-12" required maxLength={14} />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="endereco" type="text" placeholder="Endereço completo da igreja" value={endereco} onChange={(e) => setEndereco(e.target.value)} className="pl-10 h-12" required />
              </div>
            </div>
            ...
            <Button type="submit" className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-blue-500 to-purple-600 hover:opacity-90 transition-opacity" disabled={isLoading}>
              {isLoading ? (
